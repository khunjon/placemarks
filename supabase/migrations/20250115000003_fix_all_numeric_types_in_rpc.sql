-- Fix all numeric type mismatches in get_google_places_within_radius function
-- Cast rating and other numeric fields to match function signature
...
-- Create the updated function with all proper type casting
