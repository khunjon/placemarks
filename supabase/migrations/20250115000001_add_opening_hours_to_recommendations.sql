-- Add opening hours data to recommendations RPC function
-- This migration updates the get_google_places_within_radius function to include opening hours
...
-- Create the updated function with opening hours data
