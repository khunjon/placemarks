...
-- 6. Fix editorial_places policies
...
-- 8. Fix recommendation_instances policies
...
DO $$
BEGIN
    RAISE NOTICE 'Successfully optimized % RLS policies for auth.uid() performance', 35;
