...
-- 1. Fix get_list_with_places_details
...
-- 2. Fix get_user_disliked_places
...
-- 3. Fix get_google_places_within_radius
...
-- 4. Fix get_user_recommendation_preferences
...
-- 6. Fix get_place_feedback_stats
...
-- 7. Fix clear_user_recommendation_feedback
...
-- 8. Fix get_user_preference_patterns
...
-- 9. Fix get_user_lists_with_places
...
-- 10. Fix upsert_user_recommendation_preferences
